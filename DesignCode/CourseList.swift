...
//  DesignCode
//
//  Created by Ryan Spishock on 5/5/20.
            ...
            ScrollView {
                VStack(spacing: 30) {
                    ...
                    ForEach(courses.indices, id: \.self) { index in
                        ...
                        .zIndex(self.courses[index].show ? 1 : 0)  // if card is active, it will be on top (1) else, it will be on the bottom (0)
                    }
                }
                .frame(width: screen.width)
                .animation(.spring(response: 0.5, dampingFraction: 0.6, blendDuration: 0))
            }
            // will hide the status bar when a card is active
    ...
    var body: some View {
        ZStack(alignment: .top) {
            VStack(alignment: .leading, spacing: 30.0) {
                ...
                Text("Minimal coding esperience required, such as in HTML and CSS.  Please note that Xcode 11 and Catalina are essential.  Once you get everything installed, it'll get a lot freindlier!  I added a bunch of troubleshoots at the end of this page to help you navigate the issues you might encounter.")
            }
            .padding(30)
            ...
            VStack {
                HStack(alignment: .top) {
                    ...
                    ZStack {
                        ...
                        // Close button
                        // Course logo will transition to close button
                        VStack {
